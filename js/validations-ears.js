...
document.getElementById('search-btn').addEventListener('click', async () => {
    ...
    if (response.ok) {
        ...
        if(data.foreignBodyDetectionLeft === 'yes') {
            document.getElementById('foreignBodyDetectionLeftYes').checked = true;
        } else if (data.foreignBodyDetectionLeft === 'no') {
            document.getElementById('foreignBodyDetectionLeftNo').checked = true;
        }
        if(data.foreignBodyDetectionRight === 'yes') {
            document.getElementById('foreignBodyDetectionRightYes').checked = true;
        }else if (data.foreignBodyDetectionRight === 'no') {
            document.getElementById('foreignBodyDetectionRightNo').checked = true;
        }
        ...
        document.getElementById('managementRemovalBox').value = data.managementRemoval;
...
document.getElementById('update-btn').addEventListener('click', async () => {
   ...
   const foreignBodyDetectionLeft = document.getElementById('foreignBodyDetectionLeftYes').checked ? 'yes' : 'no';
   const foreignBodyDetectionRight = document.getElementById('foreignBodyDetectionRightYes').checked ? 'yes' : 'no';
    ...
    const managementRemoval = document.getElementById('managementRemovalBox').value;
    const screeningID = document.getElementById('screening-id').value;
    // Create a JSON payload
    const payload = {
        foreignBodyDetectionLeft: foreignBodyDetectionLeft,
        foreignBodyDetectionRight: foreignBodyDetectionRight,
        ...
        managementRemoval:managementRemoval
    };
...
if (earsForm) {
    earsForm.addEventListener('submit', async (event) => {
        ...
        validateCheckboxGroup('foreignBodyDetectionLeft');
        validateCheckboxGroup('foreignBodyDetectionRight');
        ...
        try {
            ...
            const foreignBodyDetectionLeft = document.getElementById('foreignBodyDetectionLeftYes').checked;
            const foreignBodyDetectionRight = document.getElementById('foreignBodyDetectionRightYes').checked;
            // Discharge Left
            ...
            const payload = {
                screeningID,
                foreignBodyDetectionLeft,
                foreignBodyDetectionRight,
                managementRemoval,
    ...
    ['foreignBodyDetectionLeft','foreignBodyDetectionLeft','dischargeLeft', 'dischargeRight', 'inflammationLeft', 'inflammationRight', 'inflamedLeft',
